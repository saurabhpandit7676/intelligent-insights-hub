      ...
      <div className="container-custom">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="glass-card p-8 rounded-xl">
              <h3 className="font-heading font-semibold text-xl mb-6">Follow Me</h3>
              <div className="flex gap-4">
                {socialLinks.map((link) => (
                  <a
                    ...
                    className="flex items-center gap-3 px-4 py-3 rounded-lg glass-card hover:bg-primary/10 transition-colors group flex-1"
                  >
