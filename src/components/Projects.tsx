...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description: "Data-driven analysis of restaurant industry trends, customer preferences, and performance metrics using advanced analytics.",
      techStack: ["Python", "Pandas", "Data Visualization", "EDA", "Matplotlib"],
